...
$opt_name = 'sanbox';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Sanbox Options', 'sanbox' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Sanbox Options', 'sanbox' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header', 'sanbox' ),
		'id'               => 'header',
		'desc'             => esc_html__( 'This section only for header', 'sanbox' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
	)
);
